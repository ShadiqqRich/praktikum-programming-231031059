...
mdata = ["Muhammad Shadiq Dzakwan",
         "cupenepen46@gmail.com",
         "PT. ABC Design",
         "JL. BALAIKOTA NO.1",
         "PAREPARE",
         "Shadiq",
...
djual = [["Pulpen","Spidol","Tinta","Penggaris","Penghapus"],
         ["B2001","B2002","B2003","B2004","B2005"],
         [27,75,12,10,3],
         [2,2,2,2,2]]
...
print("1. "+"|"+djual[1][1].ljust(13)+"|"+djual[0][1].ljust(19)+"|"+f"Rp{djual[2][1]*r},-".rjust(15)+"|"+"2".center(8)+"|"+f"Rp{2*r*djual[2][1]},-".rjust(13)+"|")
print("1. "+"|"+djual[1][2].ljust(13)+"|"+djual[0][2].ljust(19)+"|"+f"Rp{djual[2][2]*r},-".rjust(15)+"|"+"2".center(8)+"|"+f"Rp{2*r*djual[2][2]},-".rjust(13)+"|")
print("1. "+"|"+djual[1][3].ljust(13)+"|"+djual[0][3].ljust(19)+"|"+f"Rp{djual[2][3]*r},-".rjust(15)+"|"+"2".center(8)+"|"+f"Rp{2*r*djual[2][3]},-".rjust(13)+"|")
print("1. "+"|"+djual[1][4].ljust(13)+"|"+djual[0][4].ljust(19)+"|"+f"Rp{djual[2][4]*r},-".rjust(15)+"|"+"2".center(8)+"|"+f"Rp{2*r*djual[2][4]},-".rjust(13)+"|")
print("- "*39)
